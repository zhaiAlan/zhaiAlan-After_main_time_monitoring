...
//                      otherButtonTitles:nil] show];
    ...
    UIAlertController * vc = [UIAlertController alertControllerWithTitle:@"BLStopwatch 结果" message:[[BLStopwatch sharedStopwatch] prettyPrintedSplits] preferredStyle:(UIAlertControllerStyleAlert)];
